...
function addLibraryDependency(tree, context) {
    var _a;
...
function ensureProvidersFile(tree, context) {
...
function updateAppConfig(tree, context) {
...
function ensureImport(source, symbol, from) {
